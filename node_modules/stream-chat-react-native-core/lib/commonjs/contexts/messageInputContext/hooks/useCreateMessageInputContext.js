...
var useCreateMessageInputContext = function useCreateMessageInputContext(_ref) {
  ...
  var fileUploadsValue = fileUploads.map(function (_ref2) {
    var duration = _ref2.duration,
      ...
      state = _ref2.state;
    return state + "," + paused + "," + progress + "," + duration;
  }).join();
  ...
  }, [cooldownEndsAt, disabled, editingdep, fileUploadsValue, giphyActive, imageUploadsValue, maxMessageLength, mentionedUsersLength, quotedMessageId, selectedPicker, sendThreadMessageInChannel, showMoreOptions, text, threadId]);
