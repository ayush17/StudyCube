...
var Streami18n = function () {
  function Streami18n() {
    ...
    var finalOptions = (0, _extends2["default"])({}, defaultStreami18nOptions, options);
    ...
    if (translationsForLanguage) {
      this.translations[this.currentLanguage] = (0, _defineProperty2["default"])({}, defaultNS, this.translations[this.currentLanguage] && this.translations[this.currentLanguage][defaultNS] ? (0, _extends2["default"])({}, this.translations[this.currentLanguage][defaultNS], translationsForLanguage) : translationsForLanguage);
    }
    if (!this.translations[this.currentLanguage]) {
      this.translations[this.currentLanguage] = (0, _defineProperty2["default"])({}, defaultNS, {});
    }
    this.i18nextConfig = (0, _extends2["default"])({
    ...
    if (dayjsLocaleConfigForLanguage) {
      this.addOrUpdateLocale(this.currentLanguage, (0, _extends2["default"])({}, dayjsLocaleConfigForLanguage));
  ...
  (0, _createClass2["default"])(Streami18n, [{
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.prev = 1;
              _context.next = 4;
              return this.i18nInstance.init((0, _extends2["default"])({}, this.i18nextConfig, {
                lng: this.currentLanguage,
    ...
    value: function registerTranslation(language, translation, customDayjsLocale) {
      ...
      if (customDayjsLocale) {
        this.dayjsLocales[language] = (0, _extends2["default"])({}, customDayjsLocale);
    ...
    value: function addOrUpdateLocale(key, config) {
      if (this.localeExists(key)) {
        _dayjs["default"].updateLocale(key, (0, _extends2["default"])({}, config));
      } else {
        _dayjs["default"].locale((0, _extends2["default"])({
          name: key
