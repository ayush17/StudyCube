...
export declare const renderText: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(params: RenderTextParams<StreamChatGenerics>) => JSX.Element;
 ...
 */
export declare const ListOutput: ({ node, output, state, styles }: ListOutputProps) => JSX.Element;
