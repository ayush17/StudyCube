 ...
 */
export declare const ReactionList: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: ReactionListProps<StreamChatGenerics>) => JSX.Element;
