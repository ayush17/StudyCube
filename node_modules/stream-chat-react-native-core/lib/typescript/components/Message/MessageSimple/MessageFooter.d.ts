...
export declare const MessageFooter: <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: MessageFooterProps<StreamChatGenerics>) => JSX.Element;
export {};
