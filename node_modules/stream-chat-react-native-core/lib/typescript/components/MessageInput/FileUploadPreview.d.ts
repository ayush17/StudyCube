...
export declare const FileUploadPreview: {
    <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: Partial<FileUploadPreviewPropsWithContext<StreamChatGenerics>>): JSX.Element;
    displayName: string;
};
export {};
