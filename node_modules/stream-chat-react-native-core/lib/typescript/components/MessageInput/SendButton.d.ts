...
export declare const SendButton: {
    <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: Partial<SendButtonPropsWithContext<StreamChatGenerics>>): JSX.Element;
    displayName: string;
};
export {};
