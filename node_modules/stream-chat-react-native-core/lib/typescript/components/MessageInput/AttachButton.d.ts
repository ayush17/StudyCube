...
export declare const AttachButton: {
    <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: Partial<AttachButtonPropsWithContext<StreamChatGenerics>>): JSX.Element;
    displayName: string;
};
export {};
