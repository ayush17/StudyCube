...
export declare const ImageUploadPreview: {
    <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: Partial<ImageUploadPreviewPropsWithContext<StreamChatGenerics>>): JSX.Element;
    displayName: string;
};
export {};
