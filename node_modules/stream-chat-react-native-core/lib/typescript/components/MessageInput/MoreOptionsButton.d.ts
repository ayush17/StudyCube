...
export declare const MoreOptionsButton: {
    <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: Partial<MoreOptionsButtonPropsWithContext<StreamChatGenerics>>): JSX.Element;
    displayName: string;
};
export {};
