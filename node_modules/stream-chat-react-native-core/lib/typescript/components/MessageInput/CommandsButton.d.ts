...
export declare const CommandsButton: {
    <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: Partial<CommandsButtonPropsWithContext<StreamChatGenerics>>): JSX.Element;
    displayName: string;
};
export {};
