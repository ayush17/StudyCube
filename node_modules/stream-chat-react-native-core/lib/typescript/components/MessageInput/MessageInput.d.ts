...
export declare const MessageInput: {
    <StreamChatGenerics extends DefaultStreamChatGenerics = DefaultStreamChatGenerics>(props: Partial<MessageInputPropsWithContext<StreamChatGenerics>>): JSX.Element;
    displayName: string;
};
export {};
