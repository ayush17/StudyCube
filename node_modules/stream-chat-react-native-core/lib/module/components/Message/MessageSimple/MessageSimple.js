...
var MessageSimpleWithContext = function MessageSimpleWithContext(props) {
  ...
  return _react["default"].createElement(_react["default"].Fragment, null, message.pinned && _react["default"].createElement(MessagePinnedHeader, {
    __self: _this,
    __source: {
...
var areEqual = function areEqual(prevProps, nextProps) {
  ...
  var messageEqual = isPrevMessageTypeDeleted === isNextMessageTypeDeleted && prevMessage.status === nextMessage.status && prevMessage.type === nextMessage.type && prevMessage.text === nextMessage.text && prevMessage.pinned === nextMessage.pinned;
  ...
  var attachmentsEqual = Array.isArray(prevMessageAttachments) && Array.isArray(nextMessageAttachments) ? prevMessageAttachments.length === nextMessageAttachments.length && prevMessageAttachments.every(function (attachment, index) {
    var attachmentKeysEqual = attachment.image_url === nextMessageAttachments[index].image_url && attachment.og_scrape_url === nextMessageAttachments[index].og_scrape_url && attachment.thumb_url === nextMessageAttachments[index].thumb_url;
